...
const About = () => {
  const visitLinkedin = () => {
    window.location = "https://www.linkedin.com/in/shwetha-h-290392195/";
  };
  return (
    <div className="aboutContainer">
      ...
      <div className="aboutProfile">
        ...
        <span>
          IEW (India's Ethnic Wear), leading stylist and fashion icon, has
          embarked on an exciting journey in the fashion industry. With our e-
          commerce venture, www.iew.com, India’s premier ethnic wears are now
          available in all over India. Whether you're in Mumbai, New Delhi or
          Karnataka, the elite tone of Indian fashion are just a click away.
        </span>
        <span>
          IEW (India's Ethnic Wear) Store is a carefully curated design platform
        ...
        <span>
          Exclusive to the website is also our eponymous label of Ethnic wear
          collection. A stylish mix of modern and classic styles, our range will make you the most stylist in the
      ...
      <div className="aboutDeatils">
        <div className="inspiration">
          ...
          <p>
            IEW (India's Ethnic Wear) embodies an artistic lifestyle rooted in the
            ...
            your quest for authentic regality. We believe at IEW (India's Ethnic
        ...
        <div className="philosophy">
          ...
          <p>
            We at IEW (India's Ethnic Wear) believe that life should be nothing
            short of celebration and miracles and each outfit you wear is a
            reflection of that spirit. This is why each IEW (India's Ethnic Wear)
